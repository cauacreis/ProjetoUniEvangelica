...
const create = (req, res) =>{
    ...
    mongodb.getConn().collection("sala").insertOne(dados).then((response)=>{
...
const update = (req, res) => {
    ...
    if (parametro != "") {
        ...
        mongodb.getConn().collection("sala").updateOne(filter, {$set: dados}).then((response)=>{
...
const list = (req, res) => {
    ...
    mongodb.getConn().collection("sala").find(filter).toArray().then((response) => {
...
const del = (req, res) => {
    ...
    if (parametro != "") {
        ...
        mongodb.getConn().collection("sala").deleteMany(filter).then((response) => {
